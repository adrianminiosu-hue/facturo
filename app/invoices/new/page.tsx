...
export default function NewInvoice() {
  ...
  const saveInvoice = async (status: 'draft' | 'sent') => {
    ...
    if (error) { alert('Eroare la salvare!'); setSaving(false); return }
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">Completează detaliile facturii</p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            {clients.length === 0 ? (
              <p className="text-gray-400 text-sm">Nu ai clienți adăugați. <Link href="/clients" className="text-black underline">Adaugă un client</Link> mai întâi.</p>
            ) : (
              <div className="relative">
                <ClientSearch
                  clients={clients}
